...
UV Radio Room 2.2 supports only version 1.0 of MAVLink protocol. Make sure that SERIAL0_PROTOCOL and SERIAL1_PROTOCOL or SERIAL2_PROTOCOL on-board parameters are set to 1.
...
1. Copy [radioroom-2.2.0-raspbian.deb](https://envirover.s3-us-west-2.amazonaws.com/spl/2.2.0/radioroom-2.2.0-raspbian.deb) to the Raspberry Pi.
2. Install radioroom-2.2.0-raspbian.deb package.

   ``$ sudo dpkg -i radioroom-2.2.0-raspbian.deb``
...
Nov 07 07:27:57 raspberrypi radioroom[254]: Starting UV Radio Room 2.2.0...
...
Nov 07 07:27:58 raspberrypi radioroom[254]: UV Radio Room 2.2.0 started.
```
